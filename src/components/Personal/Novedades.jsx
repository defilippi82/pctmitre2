                ...
                <tbody>
                    {novedades.map(({ id, operador, fecha, novedad }) => (
                        <tr key={id}>
                            ...
                            <td>{novedad}</td>
                            <td>
                                {userData.nombre === operador && <Button variant="warning" onClick={() => handleEditNovedad(id, novedad)}><FontAwesomeIcon icon={faEdit}/></Button>}
                                {' '}
                                <Button variant="success" onClick={() => handleDeleteNovedad(id)}><FontAwesomeIcon icon={faCheck}/> </Button>
                            </td>
                        </tr>
                    ))}
                </tbody>
